  ...
  const _showFallback = (canvasId) => {
    ...
    if (el && el.parentElement) {
      el.parentElement.insertAdjacentHTML('beforeend',
        '<div style="display:flex;align-items:center;justify-content:center;height:100%;color:var(--text-muted,#64748b);font-size:.85rem;text-align:center;padding:1rem;">📊 Chart unavailable — Chart.js failed to load</div>'
      );
